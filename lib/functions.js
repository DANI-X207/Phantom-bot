...
const MODELS = [
    ...
    { alias: 'g70',   provider: 'groq',   id: 'llama-3.1-70b-versatile',         name: 'Llama 3.1 70B' },
    { alias: 'g8',    provider: 'groq',   id: 'llama-3.1-8b-instant',            name: 'Llama 3.1 8B' },
    { alias: 'g3_70', provider: 'groq',   id: 'llama3-70b-8192',                 name: 'Llama 3 70B' },
    { alias: 'g3_8',  provider: 'groq',   id: 'llama3-8b-8192',                  name: 'Llama 3 8B' },
    { alias: 'gmix',  provider: 'groq',   id: 'mixtral-8x7b-32768',              name: 'Mixtral 8x7B' },
    { alias: 'ggem2', provider: 'groq',   id: 'gemma2-9b-it',                    name: 'Gemma 2 9B' },
    { alias: 'ggem',  provider: 'groq',   id: 'gemma-7b-it',                     name: 'Gemma 7B' },

    // Gemini (4 modèles performants)
    { alias: 'gp',    provider: 'gemini', id: 'gemini-1.5-pro',                  name: 'Gemini 1.5 Pro' },
    { alias: 'gf',    provider: 'gemini', id: 'gemini-1.5-flash',                name: 'Gemini 1.5 Flash' },
    { alias: 'gf8b',  provider: 'gemini', id: 'gemini-1.5-flash-8b',             name: 'Gemini 1.5 Flash 8B' },
    { alias: 'g1p',   provider: 'gemini', id: 'gemini-1.0-pro',                  name: 'Gemini 1.0 Pro' },

    // Nvidia NIM (10 modèles performants)
    { alias: 'nv405', provider: 'nvidia', id: 'meta/llama-3.1-405b-instruct',    name: 'Llama 3.1 405B' },
    { alias: 'nv70',  provider: 'nvidia', id: 'meta/llama-3.1-70b-instruct',     name: 'Llama 3.1 70B' },
    { alias: 'nv8',   provider: 'nvidia', id: 'meta/llama-3.1-8b-instruct',      name: 'Llama 3.1 8B' },
    { alias: 'nvml',  provider: 'nvidia', id: 'mistralai/mistral-large-2-instruct', name: 'Mistral Large 2' },
    { alias: 'nvmix22', provider: 'nvidia', id: 'mistralai/mixtral-8x22b-instruct-v0.1', name: 'Mixtral 8x22B' },
    { alias: 'nvmix7', provider: 'nvidia', id: 'mistralai/mixtral-8x7b-instruct-v0.1',  name: 'Mixtral 8x7B' },
    { alias: 'nvgem27', provider: 'nvidia', id: 'google/gemma-2-27b-it',         name: 'Gemma 2 27B' },
    { alias: 'nvgem9', provider: 'nvidia', id: 'google/gemma-2-9b-it',           name: 'Gemma 2 9B' },
    { alias: 'nvphi', provider: 'nvidia', id: 'microsoft/phi-3-mini-128k-instruct', name: 'Phi-3 Mini' },
    { alias: 'nvdeep', provider: 'nvidia', id: 'deepseek-ai/deepseek-coder-6.7b-instruct', name: 'DeepSeek Coder 6.7B' }
];
...
// ── GROQ ─────────────────────────────────────────────────────────────────────
async function askGroq(messages, modelId = 'llama-3.1-8b-instant') {
...
// ── GEMINI ───────────────────────────────────────────────────────────────────
async function askGemini(messages, modelId = 'gemini-1.5-flash') {
...
// ── NVIDIA NIM ───────────────────────────────────────────────────────────────
async function askNvidia(messages, modelId = 'meta/llama-3.1-8b-instruct') {
    const key = getKey('nvidia');
    if (!key) throw new Error('NO_KEY');
    const { data } = await axios.post(
        'https://integrate.api.nvidia.com/v1/chat/completions',
        { model: modelId, max_tokens: 500, stream: false, messages },
        {
            headers: { 'Authorization': `Bearer ${key}`, 'Content-Type': 'application/json' },
            timeout: 20000
        }
