...
const MODELS = [
    ...
    { alias: 'nv8',   provider: 'nvidia', id: 'nvidia/nemotron-3-nano-omni-30b-a3b-reasoning', name: 'Nemotron 3 Nano' },
    { alias: 'nvml',  provider: 'nvidia', id: 'deepseek-ai/deepseek-v4-flash-0731', name: 'DeepSeek V4 Flash' },
    { alias: 'nvmix22', provider: 'nvidia', id: 'mistralai/mistral-large-2-instruct', name: 'Mistral Large 2' },
    { alias: 'nvgem27', provider: 'nvidia', id: 'google/gemma-4-31b-it',         name: 'Gemma 4 31B' },
    { alias: 'nvdeep', provider: 'nvidia', id: 'moonshotai/kimi-k2.6',           name: 'Kimi K2.6' }
];
